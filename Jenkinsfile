    ...
    stage('Tag Distributable') {
      ...
      steps {
        ...
        withCredentials([string(credentialsId: 'github-api-token', variable: 'TOKEN')]) {
          sh 'git push https://adi-ia-jenkins:$TOKEN@github.com/myuw-web-components/myuw-drawer.git --tags'
          sh 'git checkout -B gh-pages'
          sh 'git push https://adi-ia-jenkins:$TOKEN@github.com/myuw-web-components/myuw-drawer.git gh-pages --force'
        }
      }
    }
